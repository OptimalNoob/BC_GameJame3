...
function draw_3d_plane_xy(x1,y1,x2,y2, z){

	draw_3d_point(vbuffer, x1, y1, z, 0,0,1,0,0,c_white,1);
	draw_3d_point(vbuffer, x1, y2, z, 0,0,1,0,0,c_white,1);
	draw_3d_point(vbuffer, x2, y2, z, 0,0,1,0,0,c_white,1);

	draw_3d_point(vbuffer, x2, y2, z, 0,0,1,0,0,c_white,1);
	draw_3d_point(vbuffer, x2, y1, z, 0,0,1,0,0,c_white,1);
	draw_3d_point(vbuffer, x1, y1, z, 0,0,1,0,0,c_white,1);
};
